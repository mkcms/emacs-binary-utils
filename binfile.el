...
(define-button-type 'binfile-reloc-button
...
(defun binfile-reloc-button-action (overlay)
  (bdx-disassemble-demangled-name (overlay-get overlay 'binfile-reloc-name)))

(defun binfile-postprocess-add-relocation-buttons
    (_beg _end _name)
  (let (pos)
